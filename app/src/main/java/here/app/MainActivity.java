...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkPermissions(); //функция проверки если у нас разрешения
    }
// инициализация карты
    ...
    //функция определяет дал ли пользователь разрешения и вызывает функцию инициализации карты
    @Override
    ...
    public void requestLayer () {
        String layerUrl = "https://xyz.api.here.com/hub/spaces/OMa7kZtY/iterate?access_token=AFWTtIkeSyuf7HlDrgWIQgA";
